...
class VAE(torch.nn.Module):
    def __init__(self,ek_size,dk_size,channel,device=None):
        ...
        self.FCM = torch.nn.Linear(512*2*4,4096).to(self.device)
        self.FCV = torch.nn.Linear(512*2*4,4096).to(self.device)
        ...
        self.decoder =  torch.nn.Sequential(
            ...
            torch.nn.ConvTranspose2d(256,512,2,stride=2),        #   11
            torch.nn.ReLU(),
    ...
    def forward(self, face):
        ...
        faceout = faceout.view(-1,256,4,4)
