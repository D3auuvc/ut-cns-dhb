...
class VAE(torch.nn.Module):
    def __init__(self,ek_size,dk_size,channel):
        ...
        self.encoder =  torch.nn.Sequential(
            ...
            torch.nn.Conv2d(64, 64, ek_size, stride=1,padding=1),  #  C=64,H=102,W=188
            torch.nn.ReLU(),
            ...
            #torch.nn.Conv2d(128, 128, ek_size,stride=1,padding=1),  #  C=128,H=50,W=93
            torch.nn.ReLU(),
            ...
            #torch.nn.Conv2d(256, 256, ek_size,stride=1,padding=1),   #  C=256,H=24,W=46
            torch.nn.ReLU(),
            ...
            #torch.nn.Conv2d(512, 512, ek_size,stride=1,padding=1),   #  C=512,H=11,W=22
        ...
        self.decoder =  torch.nn.Sequential(
            ...
            torch.nn.Conv2d(16, 32, dk_size, stride=1,padding=1),   #  C=32,H=5,W=5
            torch.nn.ConvTranspose2d(32,32,3,stride=2),        #  C=32,H=11,W=15
            torch.nn.ReLU(),
            ...
            torch.nn.ConvTranspose2d(128,128,4,stride=(2,1)),      # C=128,H=24,W=32
            torch.nn.ReLU(),
            torch.nn.Conv2d(128, 256, dk_size,stride=1,padding=dk_size//2),   #  C=64,H=24,W=32
            torch.nn.Conv2d(256, 64, dk_size,stride=1,padding=1),    #  C=32,H=24,W=32
            torch.nn.ConvTranspose2d(64,64,(4,3),stride=(2,1)),           #  C=32,H=50,W=97
            torch.nn.ReLU(),
