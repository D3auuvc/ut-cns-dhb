...
class VAE(torch.nn.Module):
    def __init__(self,ek_size,dk_size,channel,device=None):
        ...
        self.FCM = torch.nn.Linear(3000,2048).to(self.device)
        self.FCV = torch.nn.Linear(3000,2048).to(self.device)
        ...
        self.decoder =  torch.nn.Sequential(
            ...
            torch.nn.ConvTranspose2d(128,512,2,stride=2),        #   11
            torch.nn.ReLU(),
    ...
    def forward(self, face):
        ...
        facefeature = self.FC1(facefeature)
        ...
        faceout = faceout.view(-1,128,4,4)
