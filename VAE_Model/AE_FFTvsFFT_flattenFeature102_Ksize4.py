...
class AE(torch.nn.Module):
    def __init__(self,ek_size,dk_size,channel,device=None):
        ...
        self.decoder =  torch.nn.Sequential(
            ...
            torch.nn.ReLU(),
            torch.nn.ConvTranspose2d(64,3,(5,4),stride=(1,2),padding=(2,0))        #   (512,102,188)
    ...
    def forward(self, face):
        ...
        facefeature = self.FCM(facefeature)
        #v = self.FCV(facefeature)
        #facev = self.relu(facev)
        #faceout = self.reparametrize(mu,v)
        facefeature = facefeature.view(-1,1,102,1)
        faceout = self.decoder(facefeature)
        ...
        return faceout,facefeature#,mu,v#,scrambleout,scramblemu,scramblev
